...
- Clarified README wording and MCP tool descriptions for accuracy
- Migrated ESLint from v8 to v9 flat config (`eslint.config.js`)

### Security

- Updated dependencies to address advisories

### Fixed

- Hardened `.gitignore` to exclude publication drafts and local artifacts
